...
export function BestsellersSection({ products: _products }: { products?: Product[] }) {
  ...
  const categorizedProducts: Record<string, Product[]> = {
    ...
    "Tuniken": [
      ...
      { id: "tunic-5", handle: "tunic-black-modest", title: "Classic Tunic Black", priceRange: { minVariantPrice: { amount: "119.00", currencyCode: "EUR" } }, variants: { edges: [{ node: { id: "v5", title: "Default" } }] }, images: { edges: [{ node: { url: "/products/abaya_black_front.jpg", altText: "Black Tunic" } }] }, options: [{ name: "Color", values: ["Black", "Beige"] }] }
    ],
    "Hijabs": [
      ...
      { id: "hijab-2", handle: "hijab-chiffon-pink", title: "Chiffon Hijab Pink", priceRange: { minVariantPrice: { amount: "29.00", currencyCode: "EUR" } }, variants: { edges: [{ node: { id: "v2", title: "Default" } }] }, images: { edges: [{ node: { url: "/products/abaya_pink_front.jpg", altText: "Pink Hijab" } }, { node: { url: "/products/abaya_pink_back.jpg", altText: "Pink Hijab Back" } }] }, options: [{ name: "Color", values: ["Pink", "Beige"] }] },
      { id: "hijab-3", handle: "hijab-jersey-green", title: "Jersey Hijab Olive", priceRange: { minVariantPrice: { amount: "25.00", currencyCode: "EUR" } }, variants: { edges: [{ node: { id: "v3", title: "Default" } }] }, images: { edges: [{ node: { url: "/products/abaya_green_front.jpg", altText: "Olive Hijab" } }, { node: { url: "/products/abaya_green_back.jpg", altText: "Olive Hijab Back" } }] }, options: [{ name: "Color", values: ["Green", "Black"] }] },
      { id: "hijab-4", handle: "hijab-jersey-beige", title: "Jersey Hijab Sand", priceRange: { minVariantPrice: { amount: "25.00", currencyCode: "EUR" } }, variants: { edges: [{ node: { id: "v4", title: "Default" } }] }, images: { edges: [{ node: { url: "/products/abaya_beige_front.jpg", altText: "Sand Hijab" } }, { node: { url: "/products/abaya_beige_back.jpg", altText: "Sand Hijab Back" } }] }, options: [{ name: "Color", values: ["Beige", "White"] }] },
      { id: "hijab-5", handle: "hijab-silk-black", title: "Premium Silk Black", priceRange: { minVariantPrice: { amount: "49.00", currencyCode: "EUR" } }, variants: { edges: [{ node: { id: "v5", title: "Default" } }] }, images: { edges: [{ node: { url: "/products/abaya_black_front.jpg", altText: "Black Hijab" } }, { node: { url: "/products/abaya_black_back.jpg", altText: "Black Hijab Back" } }] }, options: [{ name: "Color", values: ["Black", "Green"] }] }
    ]
  };
